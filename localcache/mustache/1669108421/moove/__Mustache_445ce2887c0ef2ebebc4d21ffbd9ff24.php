...
class __Mustache_445ce2887c0ef2ebebc4d21ffbd9ff24 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core/popover_region')) {
            $context->pushBlockContext(array(
                ...
                'togglecontent' => array($this, 'blockE78a5d8392a890cbf8a556ed3695ce1d'),
...
';
    ...
    public function blockE78a5d8392a890cbf8a556ed3695ce1d($context)
    {
        $indent = $buffer = '';
        $buffer .= '        <i class="fas fa-bell"></i>
';
        $buffer .= $indent . '        <div
';
