...
class __Mustache_4c6e2fc994e618ae39698f02f4400c44 extends Mustache_Template
{
...
';
            ...
            $buffer .= $this->section921ff8f7ee42eec598138d78cc914339($context, $indent, $value);
            $value = $context->find('istablist');
            if (empty($value)) {
                
                $value = $context->find('is_action_link');
                $buffer .= $this->section96132394109204f9b15e0585961dcf11($context, $indent, $value);
                $value = $context->find('is_action_link');
                if (empty($value)) {
...
';
    ...
    private function section16a82452b58c6835578e7f7874bdb6af(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section921ff8f7ee42eec598138d78cc914339(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        ';
            ...
            foreach ($values as $value) {
                ...
                $value = $context->find('is_action_link');
                $buffer .= $this->section16a82452b58c6835578e7f7874bdb6af($context, $indent, $value);
                $value = $context->find('is_action_link');
                if (empty($value)) {
...
';
    ...
    private function section96132394109204f9b15e0585961dcf11(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
