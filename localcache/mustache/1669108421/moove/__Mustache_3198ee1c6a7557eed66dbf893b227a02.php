...
class __Mustache_3198ee1c6a7557eed66dbf893b227a02 extends Mustache_Template
{
...
';
        $buffer .= $indent . '        <div class="footer-1 footer-item">
';
        $buffer .= $indent . '            <h2>Giới thiệu</h2>
';
        $buffer .= $indent . '            <p>PMC Knowledge cung cấp các chương trình đào tạo on the job training về chuyên môn, kiến thức, kỹ năng cần thiết trong lĩnh dịch vụ Bất động sản.</p>
';
        $buffer .= $indent . '            <div><button>learning now</button></div>
';
        $buffer .= $indent . '            <div class="list-icon-footer">
';
        $buffer .= $indent . '                <div><i class="fab fa-facebook-square"></i></div>
';
        $buffer .= $indent . '                <div><i class="fab fa-youtube"></i></a></div>
';
        $buffer .= $indent . '                <div><i class="fab fa-instagram-square"></i></div>
';
        $buffer .= $indent . '            </div>
';
        $buffer .= $indent . '        </div>
';
        $buffer .= $indent . '        <div class="footer-2 footer-item">
';
        $buffer .= $indent . '            <h2> Cộng đồng</h2>
';
        $buffer .= $indent . '            <p><i class="fas fa-chevron-right"></i>Câu hỏi thường gặp</p>
';
        $buffer .= $indent . '            <p><i class="fas fa-chevron-right"></i>Học bổng</p>
';
        $buffer .= $indent . '            <p><i class="fas fa-chevron-right"></i>Khóa học miễn phí </p>
';
        $buffer .= $indent . '            <p><i class="fas fa-chevron-right"></i>Trở thành giảng viên</p>
';
        $buffer .= $indent . '        </div>
';
        $buffer .= $indent . '        <div class="footer-3 footer-item">
';
        $buffer .= $indent . '            <h2>Menus</h2>
';
        $buffer .= $indent . '                <p><a class="menu-footer-course" href="#">Khóa học</a></p>
';
        $buffer .= $indent . '                <p><a class="menu-footer-course" href="#">Khóa học</a></p>
';
        $buffer .= $indent . '                <p><a class="menu-footer-course" href="#">Khóa học</a></p>
...
';
        $buffer .= $indent . '        </div>
';
        $buffer .= $indent . '        <div class="footer-4 footer-item">
';
        $buffer .= $indent . '            <h2>Khóa học nổi bật</h2>
';
        $buffer .= $indent . '            <div>
';
        $buffer .= $indent . '                <div class="blog-item">
';
        $buffer .= $indent . '                    <div class="img-block"><img src="https://masterstudy.stylemixthemes.com/white-lms/wp-content/uploads/sites/7/2018/08/photo-1517520287167-4bbf64a00d66-75x75.jpeg" alt="blog-image"/></div>
';
        $buffer .= $indent . '                    <div class="content-blog">
';
        $buffer .= $indent . '                        <h2>Our main target is to “Developing”</h2>
';
        $buffer .= $indent . '                        <div> August 9, 2018</div>
';
        $buffer .= $indent . '                    </div>
';
        $buffer .= $indent . '                <div>
