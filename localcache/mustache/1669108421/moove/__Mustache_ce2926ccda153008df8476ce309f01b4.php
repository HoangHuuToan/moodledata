...
class __Mustache_ce2926ccda153008df8476ce309f01b4 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section6ecea59cec978fc648b66659418189fd($context, $indent, $value);
        $value = $context->find('unauthenticateduser');
        if (empty($value)) {
...
';
    ...
    private function section94a398b73195b6e620c457191e07c5dc(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section6ecea59cec978fc648b66659418189fd(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        <div class="register-button">
            <button>Cơ hội nghề nghiệp</button>
        </div>
        <div class="register-button">
            <button>Đào tạo kép</button>
        </div>
        <div class="register-button">
            <button>Đối tác đào tạo</button>
        </div>
        <div class="register-button">
            <button><a href="{{output.signupurl}}">Đăng ký</a></button>
        </div>
    ...
    ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '        <div class="register-button">
';
                $buffer .= $indent . '            <button>Cơ hội nghề nghiệp</button>
';
                $buffer .= $indent . '        </div>
';
                $buffer .= $indent . '        <div class="register-button">
';
                $buffer .= $indent . '            <button>Đào tạo kép</button>
';
                $buffer .= $indent . '        </div>
';
                $buffer .= $indent . '        <div class="register-button">
';
                $buffer .= $indent . '            <button>Đối tác đào tạo</button>
';
                $buffer .= $indent . '        </div>
';
                $buffer .= $indent . '        <div class="register-button">
';
                $buffer .= $indent . '            <button><a href="';
                $value = $this->resolveValue($context->findDot('output.signupurl'), $context);
                $buffer .= ($value === null ? '' : call_user_func($this->mustache->getEscape(), $value));
                $buffer .= '">Đăng ký</a></button>
';
                $buffer .= $indent . '        </div>
';
                $buffer .= $indent . '        <div class="login pl-2">
';
                $value = $context->find('guest');
                $buffer .= $this->sectionD182cc626edac9168314bb67933bb372($context, $indent, $value);
                $value = $context->find('url');
                $buffer .= $this->section94a398b73195b6e620c457191e07c5dc($context, $indent, $value);
                $buffer .= $indent . '        </div>
';
                $buffer .= $indent . '        
';
