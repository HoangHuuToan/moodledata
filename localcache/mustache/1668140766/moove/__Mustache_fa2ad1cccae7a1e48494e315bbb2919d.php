...
class __Mustache_fa2ad1cccae7a1e48494e315bbb2919d extends Mustache_Template
{
...
';
        $buffer .= $indent . '        <div class="top-nav-left">English</div>
';
        $buffer .= $indent . '        <div class="top-nav-right">
';
        $buffer .= $indent . '            <ul>
';
        $buffer .= $indent . '                <li class="list-menu-item"><a href="#">Khóa học</a></li>
';
        $buffer .= $indent . '                <li class="list-menu-item"><a href="#">Về chúng tôi</a></li>
';
        $buffer .= $indent . '                <li class="list-menu-item"><a href="#">Kết nối</a></li>
';
        $buffer .= $indent . '            </ul>
';
        $buffer .= $indent . '            <ul>
