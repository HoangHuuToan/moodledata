...
class __Mustache_dc8c13bd655dc092e0401298cdb4c259 extends Mustache_Template
{
...
';
        $buffer .= $indent . '            <p>Masterstudy is Education WordPress theme featured by Learning Management System (LMS) for online education.</p>
';
        $buffer .= $indent . '            <div>Developed by StylemixThemes.</div>
';
...
';
        $buffer .= $indent . '            <h2>Địa chỉ</h2>
';
        $buffer .= $indent . '            <p><i class="fas fa-map-marker"></i>88 Láng Hạ, Q. Đống Đa</p>
';
        $buffer .= $indent . '            <p><i class="fas fa-phone-alt"></i>0904 615 855</p>
';
        $buffer .= $indent . '            <p><i class="fas fa-fax"></i>0904 615 855</p>
';
        $buffer .= $indent . '            <p><i class="fas fa-envelope"></i>pmc@vnpt.vn</p>
';
        $buffer .= $indent . '        </div>
';
